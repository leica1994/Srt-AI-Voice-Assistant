i18n_dict = {
    ...
    "No subtitles are going to be resynthesized.": "没有需要重新合成的字幕！",
    ...
    "Maximum audio acceleration ratio (requires ffmpeg)": "音频最大加速倍率，尝试加速音频以和起止时间同步。要求安装ffmpeg",
    ...
    "List Archives": "列出所有存档",
    "No Archives Found. Click the <List Archives> button to refresh.": "没有存档，点击<列出所有存档>按钮刷新",
    "Submodule Settings": "子模块设置",
    "Python Interpreter Path for Index-TTS": "设置Index-TTS环境路径",
    "Root Path of Index-TTS": "Index-TTS项目根目录",
